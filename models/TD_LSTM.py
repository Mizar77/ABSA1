...
class TD_LSTM(nn.Module):
    def __init__(self, args):
        ...
        self.lstml = nn.LSTM(args.embed_dim, args.hidden_size, args.num_layers, batch_first=True)
        self.lstmr = nn.LSTM(args.embed_dim, args.hidden_size, args.num_layers, batch_first=True)
